...
<div class="container my-5">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>Senin 1 Mei</td>
                <td>Ziarah ke Banten</td>
            </tr>
            <tr>
                <td>Selasa 2 Mei</td>
                <td>Ngaji Kitab Nahwu</td>
            </tr>
            <tr>
                <td>Rabu 3 Mei</td>
                <td>Tadarusan</td>
            ...
            <thead>
            <tr>
                <th scope="col">Minggu depan</th>
                <th scope="col">Kegiatan</th>
            </tr>
        </thead>
            <tr>
                <td>Senin 8 Mei</td>
                <td>Ngaji di Makam Abah</td>
            </tr>
            <tr>
                <td>Selasa 9 Mei</td>
                <td>Ngaji Kitab Aqidah</td>
            </tr>
            <tr>
                <td>Rabu 10 Mei</td>
                <td>Tadarusan</td>
